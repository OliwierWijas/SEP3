...
public final class FoodSellerServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<foodSeller.DeleteFoodSellerAccountRequest,
      ...
      io.grpc.MethodDescriptor.<foodSeller.DeleteFoodSellerAccountRequest, foodSeller.FoodSellerEmptyResponse>newBuilder()
          ...
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<foodSeller.GetFoodSellerByIdRequest,
      foodSeller.GetFoodSellerByIdResponse> METHOD_GET_FOOD_SELLER_BY_ID =
      io.grpc.MethodDescriptor.<foodSeller.GetFoodSellerByIdRequest, foodSeller.GetFoodSellerByIdResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "foodSeller.FoodSellerService", "GetFoodSellerById"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              foodSeller.GetFoodSellerByIdRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              foodSeller.GetFoodSellerByIdResponse.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<foodSeller.GetAllFoodSellersRequest,
      foodSeller.GetAllFoodSellersResponse> METHOD_GET_ALL_FOOD_SELLERS =
      io.grpc.MethodDescriptor.<foodSeller.GetAllFoodSellersRequest, foodSeller.GetAllFoodSellersResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "foodSeller.FoodSellerService", "GetAllFoodSellers"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              foodSeller.GetAllFoodSellersRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static abstract class FoodSellerServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getFoodSellerById(foodSeller.GetFoodSellerByIdRequest request,
        io.grpc.stub.StreamObserver<foodSeller.GetFoodSellerByIdResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_GET_FOOD_SELLER_BY_ID, responseObserver);
    }

    /**
     */
    public void getAllFoodSellers(foodSeller.GetAllFoodSellersRequest request,
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            METHOD_GET_FOOD_SELLER_BY_ID,
            asyncUnaryCall(
              new MethodHandlers<
                foodSeller.GetFoodSellerByIdRequest,
                foodSeller.GetFoodSellerByIdResponse>(
                  this, METHODID_GET_FOOD_SELLER_BY_ID)))
          .addMethod(
            METHOD_GET_ALL_FOOD_SELLERS,
            asyncUnaryCall(
              new MethodHandlers<
  ...
  public static final class FoodSellerServiceStub extends io.grpc.stub.AbstractStub<FoodSellerServiceStub> {
    ...
    public void getFoodSellerById(foodSeller.GetFoodSellerByIdRequest request,
        io.grpc.stub.StreamObserver<foodSeller.GetFoodSellerByIdResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_GET_FOOD_SELLER_BY_ID, getCallOptions()), request, responseObserver);
    }
  ...
  public static final class FoodSellerServiceBlockingStub extends io.grpc.stub.AbstractStub<FoodSellerServiceBlockingStub> {
    ...
    /**
     */
    public foodSeller.GetFoodSellerByIdResponse getFoodSellerById(foodSeller.GetFoodSellerByIdRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_GET_FOOD_SELLER_BY_ID, getCallOptions(), request);
    }
  ...
  public static final class FoodSellerServiceFutureStub extends io.grpc.stub.AbstractStub<FoodSellerServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<foodSeller.GetFoodSellerByIdResponse> getFoodSellerById(
        foodSeller.GetFoodSellerByIdRequest request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_GET_FOOD_SELLER_BY_ID, getCallOptions()), request);
    }

    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<foodSeller.GetAllFoodSellersResponse> getAllFoodSellers(
        foodSeller.GetAllFoodSellersRequest request) {
      return futureUnaryCall(
      ...
      switch (methodId) {
        ...
        case METHODID_DELETE_ACCOUNT:
          serviceImpl.deleteAccount((foodSeller.DeleteFoodSellerAccountRequest) request,
              (io.grpc.stub.StreamObserver<foodSeller.FoodSellerEmptyResponse>) responseObserver);
          break;
        case METHODID_GET_FOOD_SELLER_BY_ID:
          serviceImpl.getFoodSellerById((foodSeller.GetFoodSellerByIdRequest) request,
              (io.grpc.stub.StreamObserver<foodSeller.GetFoodSellerByIdResponse>) responseObserver);
          break;
        case METHODID_GET_ALL_FOOD_SELLERS:
