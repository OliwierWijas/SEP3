...
public final class FoodOfferServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<foodOffer.DeleteFoodOfferRequest,
      ...
      io.grpc.MethodDescriptor.<foodOffer.DeleteFoodOfferRequest, foodOffer.FoodOfferEmptyResponse>newBuilder()
          ...
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<foodOffer.ReadFoodOfferByIdRequest,
      foodOffer.ReadFoodOfferByIdResponse> METHOD_READ_FOOD_OFFER_BY_ID =
      io.grpc.MethodDescriptor.<foodOffer.ReadFoodOfferByIdRequest, foodOffer.ReadFoodOfferByIdResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "foodOffer.FoodOfferService", "readFoodOfferById"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              foodOffer.ReadFoodOfferByIdRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              foodOffer.ReadFoodOfferByIdResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class FoodOfferServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void readFoodOfferById(foodOffer.ReadFoodOfferByIdRequest request,
        io.grpc.stub.StreamObserver<foodOffer.ReadFoodOfferByIdResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_READ_FOOD_OFFER_BY_ID, responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          ...
          .addMethod(
            METHOD_READ_FOOD_OFFER_BY_ID,
            asyncUnaryCall(
              new MethodHandlers<
                foodOffer.ReadFoodOfferByIdRequest,
                foodOffer.ReadFoodOfferByIdResponse>(
                  this, METHODID_READ_FOOD_OFFER_BY_ID)))
          .build();
    }
  }
  ...
  public static final class FoodOfferServiceStub extends io.grpc.stub.AbstractStub<FoodOfferServiceStub> {
    ...
    public void readFoodOfferById(foodOffer.ReadFoodOfferByIdRequest request,
        io.grpc.stub.StreamObserver<foodOffer.ReadFoodOfferByIdResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_READ_FOOD_OFFER_BY_ID, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class FoodOfferServiceBlockingStub extends io.grpc.stub.AbstractStub<FoodOfferServiceBlockingStub> {
    ...
    /**
     */
    public foodOffer.ReadFoodOfferByIdResponse readFoodOfferById(foodOffer.ReadFoodOfferByIdRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_READ_FOOD_OFFER_BY_ID, getCallOptions(), request);
    }
  }
  ...
  public static final class FoodOfferServiceFutureStub extends io.grpc.stub.AbstractStub<FoodOfferServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<foodOffer.ReadFoodOfferByIdResponse> readFoodOfferById(
        foodOffer.ReadFoodOfferByIdRequest request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_READ_FOOD_OFFER_BY_ID, getCallOptions()), request);
    }
  }
  ...
  private static final int METHODID_READ_FOOD_OFFER_BY_ID = 5;
      ...
      switch (methodId) {
        ...
        case METHODID_DELETE_FOOD_OFFER:
          serviceImpl.deleteFoodOffer((foodOffer.DeleteFoodOfferRequest) request,
              (io.grpc.stub.StreamObserver<foodOffer.FoodOfferEmptyResponse>) responseObserver);
          break;
        case METHODID_READ_FOOD_OFFER_BY_ID:
          serviceImpl.readFoodOfferById((foodOffer.ReadFoodOfferByIdRequest) request,
              (io.grpc.stub.StreamObserver<foodOffer.ReadFoodOfferByIdResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (FoodOfferServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(METHOD_READ_FOOD_OFFER_BY_ID)
              .build();
        }
      }
    }
